<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Catalogs.Master" CodeBehind="Courier.aspx.cs" Inherits="CardPerso.Courier" %>
<asp:Content ID="CourierHeader" runat="server" ContentPlaceHolderID="CatalogHeaderContent">
    <title>Курьерские службы</title>
</asp:Content>
<asp:Content ID="CourierContent" runat="server" ContentPlaceHolderID="CatalogContent">
    <table width="100%">
            <tr>
            <td>
                <asp:ImageButton ID="bNew" runat="server" ImageUrl="~/Images/new.gif" 
                    ToolTip="Новый" OnClientClick="return show_catalog('type=courier&mode=1');" onclick="bNew_Click" />
            ...
            <td align="right">
             ...
             <td colspan="2">
                ...
                <asp:GridView ID="gvCouriers" runat="server" AutoGenerateColumns="False" width="97%"  
                    BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                    CellPadding="3" 
                    DataKeyNames="id,name" 
                    onselectedindexchanged="gvCouriers_SelectedIndexChanged">
