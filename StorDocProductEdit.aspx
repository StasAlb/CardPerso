<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StorDocProductEdit.aspx.cs" Inherits="CardPerso.StorDocProductEdit" %>
...
<body style="margin: 0px; background-color: #F7F7DE;">
    ...
    <table width="100%">
            ...
            <tr>
                <td style="width: 15%">
                    <asp:Label ID="Label14" runat="server" Text="Новые"></asp:Label>
                </td>
                <td style="width: 80%">
                <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="width: 20%">
                                  <asp:TextBox ID="tbCnt_New" runat="server" Width="90%"></asp:TextBox>
                            </td>
                            <td style="width: 20%" align="center">
                                <asp:Label ID="Label15" runat="server" Text="Персо"></asp:Label>
                            </td>
                            <td style="width: 20%">
                                <asp:TextBox ID="tbCnt_Perso" runat="server" Width="90%"></asp:TextBox>
                            </td>
                            <td style="width: 20%" align="center">
                                <asp:Label ID="Label1" runat="server" Text="Брак"></asp:Label>
                            </td>
                            <td style="width: 20%">
                                <asp:TextBox ID="tbCnt_Brak" runat="server" Width="90%"></asp:TextBox>
                            </td>
                        </tr>   
                    </table>
                </td>
