<%@ Page Title="Смена пароля" Language="C#" MasterPageFile="~/CardPerso.master" AutoEventWireup="true"
        ...
        <ChangePasswordTemplate>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="CancelPushButton" runat="server" CausesValidation="False" CommandName="Cancel" Text="Отмена" Visible="false"/>
