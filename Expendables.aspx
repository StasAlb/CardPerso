<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Catalogs.Master" CodeBehind="Expendables.aspx.cs" Inherits="CardPerso.Expendables" %>
<asp:Content ContentPlaceHolderID="CatalogHeaderContent" ID="ExpendablesHeader" runat="server">
    <title>Расходные материалы</title>
</asp:Content>
<asp:Content ContentPlaceHolderID="CatalogContent" ID="ExpendablesContent" runat="server">
    <table width="100%">
            <tr>
            <td>
                <asp:ImageButton ID="bNew" runat="server" ImageUrl="~/Images/new.gif" 
                    ToolTip="Новый" OnClientClick="return show_catalog('type=expendable&mode=1');" onclick="bNew_Click" />
            ...
            <td align="right">
             ...
             <td colspan="2">
                ...
                <asp:GridView ID="gvExpendables" runat="server" AutoGenerateColumns="False" width="97%"  
                    BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                    CellPadding="3" 
                    DataKeyNames="id,name" 
                    onselectedindexchanged="gvExpendables_SelectedIndexChanged">
